...
function onCreate()
    ...
    addCharacterToList('stan', 'dad')
    addCharacterToList('cartman', 'dad')
    addCharacterToList('cartmanflip', 'dad')
    addCharacterToList('kenny', 'dad')
    addCharacterToList('buttersflip', 'boyfriend')
    addCharacterToList('buttersleft', 'boyfriend')
    addCharacterToList('buttersright', 'boyfriend')
    addCharacterToList('buttershap', 'boyfriend')
end
...
function onStepHit()
    ...
    if curStep == 1040 then --xenophane
        ...
        triggerEvent('Change Character', 'dad', 'cartman')
        triggerEvent('Change Character', 'nashe', 'buttersright')

        setProperty('boyfriend.x', 502.45 + 300)
        setProperty('boyfriend.y', 370.45)
        setProperty('dad.x', 180 + 100)
        setProperty('dad.y', -50 + 100)
    ...
    if curStep == 1296 then --knuckk
        ...
        triggerEvent('Change Character', 'dad', 'stan')
        triggerEvent('Change Character', 'nashe', 'buttersflip')

        setProperty('boyfriend.x', 466.1)
        setProperty('boyfriend.y', 685.6 - 300)
        setProperty('dad.x', 1300 + 100 - 206)
        setProperty('dad.y', 230 + 94)
    end
    ...
    if curStep == 2320 then --xenophane right
        ...
        triggerEvent('Change Character', 'dad', 'cartmanflip')
        triggerEvent('Change Character', 'nashe', 'buttersleft')
    ...
    if curStep == 2823 then --eggdick face event
        ...
        triggerEvent('Change Character', 'dad', 'kenny')
        triggerEvent('Change Character', 'nashe', 'buttershap')

        setProperty('boyfriend.x', 466.1 + 200)
        setProperty('boyfriend.y', 685.6 - 250)
        setProperty('dad.x', 170 - 200)
        setProperty('dad.y', 235 + 200)
    end
